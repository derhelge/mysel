...
CREATE TABLE vlanoverride_vlanoverride (
	id int8 NOT NULL,
...
GRANT ALL PRIVILEGES ON TABLE vlanoverride_vlanoverride TO ${POSTGRES_REPLICATION_USER};
GRANT ALL PRIVILEGES ON TABLE iotdevices_iotdeviceaccount TO ${POSTGRES_REPLICATION_USER};
 ...
 *
 */
GRANT SELECT ON rad_mac_auth TO radius;
